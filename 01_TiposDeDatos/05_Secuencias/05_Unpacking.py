...
valor1, valor2, *valor3 = 1, 2, 3, 4, 5, 6, 7, 8, 9  # * adelante de una variable almacena varios datos en una lista
print(valor1, valor2, valor3)

valor1, valor2, *valor3, valor4, valor5 = 1, 2, 3, 4, 5, 6, 7, 8, 9  # como se almacena 1 2 [3, 4, 5, 6, 7] 8 9
...
def regresa_varios_datos():
    return 1, 2, 3  # Se ingresan como tupla
